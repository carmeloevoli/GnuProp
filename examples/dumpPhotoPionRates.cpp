...
void testInteractionRate() {
  {
    gnuprop::PhotoPionProductionRate gnu("data/gnuprop_photopion_neutrinos_cmb.bin");
    std::ofstream out("output/gnuprop_neutrinos_rate_xaxis.txt");
  ...
  {
    gnuprop::PhotoPionProductionRate gnu("data/gnuprop_photopion_gammas_cmb.bin");
    std::ofstream out("output/gnuprop_gammas_rate_xaxis.txt");
    out << "# Enu [eV] - rates[Gyr] \n";
    out << std::scientific;
    const auto units = 1. / SI::Gyr;
    auto xAxis = simprop::utils::LogAxis<double>(1e-4, 1, 1000);
  ...
  {
    gnuprop::PhotoPionProductionRate gnu("data/gnuprop_photopion_pairs_cmb.bin");
    std::ofstream out("output/gnuprop_pairs_rate_xaxis.txt");
    out << "# Enu [eV] - rates[Gyr] \n";
    out << std::scientific;
    const auto units = 1. / SI::Gyr;
    auto xAxis = simprop::utils::LogAxis<double>(1e-4, 1, 1000);
