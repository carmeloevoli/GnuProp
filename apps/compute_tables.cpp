...
class GnuPropTables {
 public:
  ...
  static std::unique_ptr<cache::PhotoPairCached> photoPairCached(
    ...
    photoPair->buildPrimaryEnergyAxis(1e10 * SI::eV, 1e24 * SI::eV, 14 * 16);
    photoPair->buildSecondaryEnergyAxis(1e10 * SI::eV, 1e24 * SI::eV, 14 * 16);
  ...
  static std::unique_ptr<cache::InverseComptonCached> inverseComptonCached(
    ...
    ic->buildPrimaryEnergyAxis(1e10 * SI::eV, 1e24 * SI::eV, 14 * 16);
    ic->buildSecondaryEnergyAxis(1e10 * SI::eV, 1e24 * SI::eV, 14 * 16);
