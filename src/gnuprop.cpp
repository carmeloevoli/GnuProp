...
void GnuProp::build() {
  ...
  m_gamma_absorption =
      std::make_unique<gnuprop::AbsorptionRate>("data/gnuprop_absorption_gammas_cmb.bin");
  m_electron_absorption =
      std::make_unique<gnuprop::AbsorptionRate>("data/gnuprop_absorption_pairs_cmb.bin");
